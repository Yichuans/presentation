...
note: 1. switch now to English, 10 years. a topic i'm most personally involved through work; 2. protected or conserved area - what, why and how, getting things done the only way


### convention, communication and conversation 
<!-- .slide: data-background="./generic_assets/wcmc-1.jpg" -->
international science policy interface
note: 1. hard task, quite nervous 2. the I remember nothing joke; look back at presentation for inspiration; but thinking back, Wen Cambridge, look back do not remember a thing, not that a shoe was thrown which i remember, but his quick thinking and me being in it thinking how he might deal with it. 3. jokingly truth and reality with 10 years under my belt, there is far more I don't know, nor do I not qualified to talk about such a big topic, let alone for taking responsibility for inadverdently misleading bright minds astray, career from doctors, to conservation -> so i thought i better focus on the thought process and my own stories rather than the technical details, which I can guarantee you will not remember, which is a good thing, because the most important knowledge does not need memorizing. 
...
note: based on my experience and my understanding, the content might or might not be of interest but i hope the thinking process behind it might be useful, of interest and relevant
...
note: 1. UN bore the world to peace. 2.joke on FAO contract: more admin than work; not to highlight its inefficency but rather predicable and hopefully effective procedures to ensure things are done correctly and with consent; 3. why. a treaties, commons rules to dictate how we work, in coordination internationally; e.g. Vienna convention for the protection of ozone layer. UNFCCC + CBD. b. framework for work to happen, e.g. setting goals, who does what, finances, workplan, task force etc
...
note: what it is. jap and korea use neutral ground, not about conservation, for airing dispute, a higher  domestic priority and political interest
...
note: look at a great example re importance of conservation; if you do i hope you agree with me, if you haven't i hope it may convince you that every single species matter in this complex and fascinating world
...
note: previously on process; how evolution of communication use wdpa as example; un list, to books and database, to interactive website, now as service


### Go digital
<!-- .slide: data-background="white" -->
>I cannot be bothered to read my own 70 papers
note: - modern humans have short attention spans - competing for attention, short quick messaging, less is more - bitesize chunks for digestion - too much data, progressive disclosure
- cater to different audience - scientists already convinced, policy maker, the content of the public (politics)
...
<!-- .slide: data-background="./generic_assets/wcmc-3.jpg" -->
note: how to comunicate itself is science but also art, and as such it can be manipulated for nefarious purposes - map projection as example
...
note: framework + science-policy mechanism; this is about how to get things done effectively 1) ideal world situation 2) it would be naive to think everything would work out as we planned - good data, good research, good evidence, good policy and good outcomes. 2) e.g. money does talk - who funds it, who gets the funding; interest groups, sure ulterior motives beyond charity; 3) powerful individuals and disproportional influence; technology plays a role; documentation; celebrity and social influencer; story telling is important; decisions are not always rational but influenced or even in some cases driven by emotions (brexit); strong belief is more powerful than dry facts 


### why fund conservation?
note: question for students: what do you think why governments, companies and indivuals give money to conservation
...
...
note: legitimate reasons you've specified - perhaps me being cynical; next three stories 
...
### Greta Thunberg
activist
note: not my favourite and contriversial, I have reservations about her method; civil disobedience and confrontational; no one would argue she has been the face of younger generation 



<i class="fa fa-book-open fa-2x"></i>
## recommendation of books
note: 1. thank you for bearing with my rambling for an hour 2. reading is a personal choice and personal preference, i do not believe what i like might be of universal relevance. Recommendations on books is old fashioned, but rather recommendations re obtaining information and knowledge - yes, books, esp well argued not necessarily popular. 1) up to date, read news: be neutral, critical, open minded, and listen to all sides of the argument, if possible different language and wide spectrum, 2) read facts and references not interpretation or opinions, e.g. manuals not tutorials, trust the original source of information. a variety of books, report up to now i have not found a book that changed my life or wish if i had read earlier in my life
